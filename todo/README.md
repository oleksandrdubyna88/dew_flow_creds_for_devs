...
| [PLAN_marketplace_listing.md](PLAN_marketplace_listing.md) | plan only | The extension is mechanically publishable; the listing is not persuasive. No screenshots, a README that opens for the wrong reader, and `categories: ["Other"]`. The screenshots are the item that matters |
