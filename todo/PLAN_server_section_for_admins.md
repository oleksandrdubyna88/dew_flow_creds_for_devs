...
| `research/architecture.md` | **no change.** Verified: it mentions neither `/api/metrics` nor the tree sections, and inventing a mention to satisfy a checklist is worse than leaving it |
