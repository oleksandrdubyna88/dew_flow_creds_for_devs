...
> round found here — [PLAN_corp_projects_share_rule.md](PLAN_corp_projects_share_rule.md)
> takes the roles, and [PLAN_corp_event_log.md](PLAN_corp_event_log.md) takes the log whose
> writer shipped here.
>
