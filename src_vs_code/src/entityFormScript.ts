...
export function formPageScript(
  ...
  document.getElementById('save').addEventListener('click', () => {
    ...
    vscode.postMessage({ type: 'save', data: {
      ...
      paymentForm: val('paymentForm'), weavePassword: chk('weavePassword'), weaveMethod: val('weaveMethod'), weaveSecondMode: val('weaveSecondMode'),
      ...
      mixFields: collectMixFields(), mixMethod: val('mixMethod'), mixMethods: collectMixMethods(), mixSecondMode: val('mixSecondMode'), secondValues: collectSecondValues(), clearSecond: collectClearSecond(),
